...
def test_base_tinycrawler():
    ...
    with HTTMock(example_mock):
        TinyCrawler(file_parser=file_parser,
                    url_validator=url_validator, use_cli=True, proxy_timeout=0, domains_timeout=0.001, proxy_path=proxy_path, cooldown_time_beetween_download_attempts=0).run(seed)
